...
| :--- | :--- | :--- |
| **[SentinelCloud](https://github.com/amantoppo1739/SentinelCloud---Scalable-Uptime-Monitoring-System)** | Distributed Uptime Monitor with BullMQ & Redis workers. | `Next.js` `Redis` `AWS` |
